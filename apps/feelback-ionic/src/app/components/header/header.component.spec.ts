...
describe('HeaderComponent', () => {
  ...
  const languageServiceMock = {
    ...
    switchLanguage: jest.fn((newLanguage: string) => {currentLanguage = newLanguage})
  }
  ...
  it('should be able to open the language dialog', () => {
    ...
    const displayLanguageDialogMock = jest.spyOn(component, 'displayLanguageDialog').mockImplementation();
    fixture.detectChanges();
    // await fixture.whenRenderingDone().then(() => console.log('rendered'));
    const ionButtonDisplayLanguage: HTMLElement = fixture.debugElement.nativeElement.querySelector('ion-button[data-cy="header-language-actual-button"]');

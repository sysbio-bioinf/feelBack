  ...
  for (const orientation of orientationList) {
    describe(
      '[Mobile Device (' +
        ...
        ') - ' +
        orientation +
        '] Testing the start page of the FeelBack-web application.',
      () => {
        beforeEach(() => {
        ...
        it('shows the features of the application', () => {
          ...
          cy.get('[data-cy=features-title] small').should(
            'have.text',
            'Features',
          );
          ...
          cy.get('[data-cy=feature-card-title-c] > h2').should(
            'not.be.visible',
          );
          cy.get('[data-cy=feature-card-title-d] > h2').should(
            'not.be.visible',
          );
        ...
        it('should display FAQs', () => {
          ...
          // );
          cy.log(
            'This needs to get tested after there is a seeded dummy backend',
          );
        });
